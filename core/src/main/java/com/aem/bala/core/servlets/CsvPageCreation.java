...
@SlingServletPaths(value = { "/bin/csvToPageCreation" })
public class CsvPageCreation extends SlingSafeMethodsServlet {
	/**
	 * 
	 */
	...
	@Reference
	CsvCreatingPage csvCreatingPage;
	...
	protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response)
		...
		try {
			...
			int pagesCreated = csvCreatingPage.createPage();
			if (pagesCreated >0) {
